...
def main():
    ...
    with st.sidebar:
        st.markdown("---")
        st.markdown(
            '<h6>Made in &nbsp<img src="https://streamlit.io/images/brand/streamlit-mark-color.png" alt="Streamlit logo" height="16">&nbsp by <a href="https://twitter.com/">@rj</a></h6>',
    ...
    * In polygon mode, left-click to add a point, right-click to close the polygon, double-click to remove the latest point
    """
        ...
        drawing_mode = st.sidebar.selectbox(
            "Drawing tool:",
            ("point", "line", "rect", "circle", "polygon" ),
        )
